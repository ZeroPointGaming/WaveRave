...
stack(  
    note("<[c2 c3]*4 [bb1 bb2]*4 [f2 f3]*4 [eb2 eb3]*4>").sound("gm_fx_atmosphere")
       .lpf(slider(4080.2, 200, 6000)).gain(slider(1.346, 0, 2.0)),

    every(4, (p) => p.fast(2), s("bd ~ bd ~")).sound("9000_bd").gain(slider(1, 0, 1.0))
        .delay(0.05).delayfeedback(0.1).shape(0.4),
